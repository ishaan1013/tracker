    ...
    <>
      {session ? (
        ...
        <button
          ...
          className="peer mt-8 flex w-full items-center justify-center rounded bg-blue-700 py-3 font-semibold text-white duration-100 hover:bg-blue-700 focus:outline-blue-400">
