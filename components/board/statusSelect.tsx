...
const Status = () => {
  ...
  return (
    <Select.Root value={val} onValueChange={(value) => setVal(value)}>
      <Select.Trigger
        className={`mb-3 ml-3 flex select-none items-center rounded border-[1px] border-blue-700 py-1 px-2.5 text-base text-blue-700 duration-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/75 focus:ring-offset-0`}>
        <Select.Value />
        <Select.Icon>
