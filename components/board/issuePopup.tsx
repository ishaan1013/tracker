...
const IssueSelect = ({
  ...
  return type === 0 ? (
    <button
      onClick={() => setType(1)}
      className="flex select-none items-center rounded border-[1px] border-blue-700 bg-blue-50 py-0.5 pl-1.5 pr-2 text-[0.95rem] font-medium text-blue-700 duration-100 hover:bg-blue-100 focus:outline-none focus:ring-[3px] focus:ring-blue-500/75 focus:ring-offset-0">
  ...
  return (
    <Dialog.Root open={opened} onOpenChange={setOpened}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="DialogContent xs:w-[90%] fixed left-1/2 top-1/2 z-50 flex w-[95%] -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-md border-[1px] border-gray-300 bg-white p-6 focus:outline-none focus:ring-[3px] focus:ring-blue-500/75 focus:ring-offset-0 lg:w-[60rem]">
          ...
          <div className="mt-8 flex items-center self-start">
            <button
              className={`flex items-center whitespace-nowrap rounded bg-blue-700 py-2 pl-4 pr-5 text-base text-white duration-100 hover:bg-blue-600 focus:outline-none focus:ring-[3px] focus:ring-blue-500/75 focus:ring-offset-0`}>
